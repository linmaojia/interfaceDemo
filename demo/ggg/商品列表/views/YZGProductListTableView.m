...
@interface YZGProductListTableView ()<UITableViewDelegate,UITableViewDataSource>


@end
@implementation YZGProductListTableView
...
- (instancetype)initWithFrame:(CGRect)frame style:(UITableViewStyle)style
{
    if (self = [super initWithFrame:frame style:style])
    {
        ...
        [self registerClass:[YZGProductListCell class] forCellReuseIdentifier:@"ProductListCell"];
